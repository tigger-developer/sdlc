...
func parseOptionsTo(arguments []string, output io.Writer) (auditrunner.Options, error) {
	...
	flags.StringVar(&options.Harness, "harness", "", "audit harness compatibility override; non-Hermes values warn and use Hermes")
	flags.StringVar(&options.Provider, "provider", "", "override audit provider")
...
func printUsage(output io.Writer) {
	...
	fmt.Fprintln(output, "  --harness NAME      compatibility override; non-Hermes values warn and use Hermes")
	fmt.Fprintln(output, "  --provider NAME     override audit provider")
